    ...
    return (
        <div className="bg-background min-h-screen flex flex-col relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-[800px] pointer-events-none z-0">
                <div className="absolute inset-0 opacity-10 dark:opacity-20" style={{ backgroundImage: "radial-gradient(currentColor 2px, transparent 2px)", backgroundSize: "30px 30px" }}></div>
            </div>
            ...
            <motion.nav 
                ...
                className="fixed top-0 w-full z-50 bg-surface cartoon-border flex justify-between items-center px-8 h-20"
            >
                ...
                <div className="flex items-center gap-6">
                    ...
                    <Link href="/login" className="bg-primary text-on-primary font-label-md text-label-md px-6 py-2.5 rounded-full cartoon-btn">
                        Mulai Sekarang
                    </Link>
                </div>
            </motion.nav>
            ...
            <main className="flex-grow pt-32 pb-16 flex flex-col w-full z-10">
                ...
                <section className="w-full px-6 py-12 md:py-24 flex flex-col items-center text-center max-w-4xl mx-auto">
                    <motion.div
                        ...
                        className="inline-block mb-6 px-4 py-1.5 rounded-full bg-secondary text-on-secondary font-label-sm cartoon-border cartoon-shadow"
                    >
                    ...
                    >
                        <Link href="/login" className="bg-primary text-on-primary font-label-md px-8 py-4 rounded-full text-center text-lg cartoon-btn">
                            Mulai Sekarang
                        </Link>
                        <Link href="#features" className="bg-surface text-on-surface font-label-md px-8 py-4 rounded-full text-center text-lg cartoon-btn">
                            Pelajari Fitur
                        </Link>
                    </motion.div>
                </section>
                ...
                <section id="features" className="w-full px-6 py-24 max-w-6xl mx-auto">
                    ...
                    >
                        {/* Feature 1 */}
                        <div className="bg-surface p-8 rounded-2xl flex flex-col gap-4 cartoon-border cartoon-shadow hover:-translate-y-2 transition-transform duration-300 group">
                            <div className="w-14 h-14 rounded-xl bg-primary flex items-center justify-center text-on-primary cartoon-border group-hover:rotate-6 transition-transform">
                                <Activity size={28} />
                            </div>
                        ...
                        {/* Feature 2 */}
                        <div className="bg-surface p-8 rounded-2xl flex flex-col gap-4 cartoon-border cartoon-shadow hover:-translate-y-2 transition-transform duration-300 group">
                            <div className="w-14 h-14 rounded-xl bg-secondary flex items-center justify-center text-on-secondary cartoon-border group-hover:-rotate-6 transition-transform">
                                <ShieldCheck size={28} />
                            </div>
                        ...
                        {/* Feature 3 */}
                        <div className="bg-surface p-8 rounded-2xl flex flex-col gap-4 cartoon-border cartoon-shadow hover:-translate-y-2 transition-transform duration-300 group">
                            <div className="w-14 h-14 rounded-xl bg-tertiary flex items-center justify-center text-on-tertiary cartoon-border group-hover:rotate-6 transition-transform">
                                <BarChart3 size={28} />
                            </div>
            ...
            {/* Footer */}
            <footer className="w-full py-8 mt-auto bg-surface cartoon-border flex flex-col md:flex-row justify-between items-center px-12 gap-6 z-10 relative">
