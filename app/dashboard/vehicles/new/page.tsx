    ...
    <div className="p-6 flex-1 flex flex-col max-w-7xl mx-auto w-full">
      ...
      <div className="bg-surface-container-low border border-outline-variant rounded-lg p-6 md:p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4 flex items-center justify-end gap-4 border-t border-outline-variant">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="px-6 py-3 bg-primary text-on-primary rounded-lg font-label-md text-label-md font-bold transition-all hover:bg-primary-fixed disabled:opacity-70 flex items-center gap-2"
            >
              {loading ? (
